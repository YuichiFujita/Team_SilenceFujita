...
#define RAIN_RADIUS_X		(0.6f)						// 雨の半径(X軸)
#define RAIN_RADIUS_Y		(3.0f)						// 雨の半径(Y軸)
...
#define SNOW_RANGE			(900)						// 雨の降る範囲
#define SNOW_GENERATE		(30)						// 雨の生成数
#define SNOW_MOVE_RANGE		(6)							// 雨の速度の範囲
#define SHIFT_SNOW			(100.0f)					// 雨のずらす幅
#define SNOW_RADIUS_X		(1.2f)						// 雨の半径(X軸)
#define SNOW_RADIUS_Y		(1.2f)						// 雨の半径(Y軸)
#define SNOW_HEIGHT			(300.0f)					// 雨の降る高さ
